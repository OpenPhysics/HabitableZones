...
export class StringManager {
  ...
  public getScreenNames(): {
    readonly circumstellarStringProperty: ReadOnlyProperty<string>;
    readonly galacticStringProperty: ReadOnlyProperty<string>;
  } {
    return {
   ...
   */
  public getCircumstellarA11yStrings() {
    return stringProperties.a11y.circumstellar;
  }

  public getGalacticA11yStrings() {
    return stringProperties.a11y.galactic;
  }
